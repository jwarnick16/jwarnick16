...
formElem.onsubmit = function(event) {
    ...
    // QUIZ
    // what happens if we don't do this? - the default action of the function will execute every time instead of the desired action specified within the function such as the error message validation
    event.preventDefault();

    // QUIZ
    // what happens if we don't do this? - the error code will remain on the screen even after valid input
    clearError();
